...
export default function FinancialSummary({ financials }: FinancialSummaryProps) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm group hover:border-slate-300 transition-all duration-300">
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm group hover:border-slate-300 transition-all duration-300">
        ...
        <div className="flex items-baseline gap-1">
          <span className={`text-3xl font-bold tracking-tight ${financials.dueToday && financials.dueToday !== '₱0.00' ? 'text-orange-600' : 'text-slate-900'}`}>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm group hover:border-slate-300 transition-all duration-300 sm:col-span-2 lg:col-span-1">
        <div className="flex items-center gap-3 mb-4">
          <div className="bg-red-50 p-2 rounded-lg text-red-600 border border-red-100">
            <TrendingDown className="h-4 w-4" />
          </div>
          <h3 className="text-slate-400 font-bold uppercase text-[10px] tracking-wider">Remaining Balance</h3>
        </div>
        <div className="flex items-baseline gap-1">

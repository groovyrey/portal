  ...
  return (
    <div className="bg-card rounded-[2rem] shadow-sm border border-border p-8 mb-8">
            ...
            {subjects.slice(0, 5).map((sub, idx) => (
              ...
              >
                <td className="px-6 py-5 whitespace-nowrap">
                  <span className="text-[10px] font-black text-muted-foreground font-mono bg-accent px-2 py-1 rounded group-hover:bg-blue-100 group-hover:text-blue-600 transition-colors">
                    {sub.code}
                  </span>
                </td>
      ...
      {subjects.length > 5 && (
        <Link 
          href="/subjects"
          className="mt-6 flex items-center justify-center py-4 border-2 border-dashed border-border rounded-2xl text-[10px] font-black text-muted-foreground uppercase tracking-widest hover:border-blue-200 hover:text-blue-600 transition-all group"
        >

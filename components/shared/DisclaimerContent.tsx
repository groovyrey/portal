...
export default function DisclaimerContent() {
  return (
    <div className="grid gap-8">
      ...
      <div className="bg-primary rounded-lg p-6 text-primary-foreground relative overflow-hidden border border-primary-foreground/5">
        <div className="absolute top-0 right-0 p-4 opacity-10">
          <ShieldCheck size={140} />
        </div>
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary-foreground/10 text-primary-foreground text-xs font-medium rounded-md border border-primary-foreground/20 mb-6">
            <Info className="h-3 w-3" />
            Your Data & How We Use It
          </div>
          <h2 className="text-xl font-bold mb-4">How & Why We Use Your Data</h2>
          ...
          <ul className="grid md:grid-cols-2 gap-4 text-sm font-semibold text-primary-foreground/90">
            <li className="flex items-start gap-3">
              <div className="h-5 w-5 bg-primary-foreground/10 rounded-md flex items-center justify-center text-primary-foreground shrink-0">✓</div>
      ...
      <div className="relative overflow-hidden bg-card p-6 rounded-lg border border-border">
        <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
          <ShieldAlert size={120} />
        </div>
        <div className="relative z-10">
          <div className="h-12 w-12 rounded-md bg-amber-500/10 flex items-center justify-center text-amber-600 dark:text-amber-400 mb-6">
      ...
      <div className="space-y-12 mt-8">
        <section>
          <h3 className="text-base font-semibold text-foreground mb-4 border-l-2 border-primary pl-3">
        ...
        <section className="bg-primary text-primary-foreground rounded-lg p-6 mt-16">
          ...
          <div className="grid gap-6 text-primary-foreground/80 text-sm leading-relaxed">
            ...
            <div className="pt-4 border-t border-primary-foreground/10">
              <p className="text-xs font-medium text-primary-foreground/60 italic">

  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-6 text-center">
      <div className="mb-8 relative">
        <div className="h-20 w-20 bg-destructive/10 rounded-lg flex items-center justify-center">
          <Lock className="h-9 w-9 text-destructive" />
        </div>
        <div className="absolute -top-2 -right-2 bg-background p-2 rounded-md border">
          <ShieldAlert className="h-6 w-6 text-warning" />
        </div>
      </div>

      <h1 className="text-xl font-bold tracking-tight text-foreground mb-3">Access Restricted</h1>

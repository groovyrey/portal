      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
          ...
          <section>
            ...
            <div className="grid gap-4">
              <div className="bg-card p-6 rounded-2xl border border-border shadow-sm">
                <h3 className="text-base font-bold mb-2 text-foreground">Authentication</h3>
              ...
              <div className="bg-card p-6 rounded-2xl border border-border shadow-sm">
                <h3 className="text-base font-bold mb-2 text-foreground">Your Dashboard</h3>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-slate-800 rounded-xl border border-slate-700">
                    ...
                    <p className="text-[10px] text-muted-foreground font-medium">HTTP-only cookies and secure storage keep your login active and safe.</p>
                  </div>
                  <div className="p-4 bg-slate-800 rounded-xl border border-slate-700">
                    <h4 className="font-bold text-xs mb-1">Audit Logs</h4>
                    <p className="text-[10px] text-muted-foreground font-medium">System activity is monitored to ensure the integrity of the student community.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <footer className="mt-20 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <Link href="/disclaimer" className="text-[10px] font-bold text-muted-foreground hover:text-foreground transition-colors uppercase tracking-wider">Disclaimer</Link>
            <Link href="/" className="text-[10px] font-bold text-muted-foreground hover:text-foreground transition-colors uppercase tracking-wider">Home</Link>
          </div>
        </footer>
      </div>
    </div>
